...
<head>
    ...
    <style>
        ...
        * {
        ...
        .table-container {
            max-height: 500px; /* Kept same as original */
            width: 100%;
            overflow-y: auto;
            overflow-x: auto;
            position: relative;
        ...
        .survey-table td:first-child {
            ...
            z-index: 5;
            background: #E6E6FA;
            min-width: 250px; /* Increased for wider portal */
        }
        ...
        .survey-table td:not(:first-child) {
            min-width: 150px; /* Increased for wider portal */
            white-space: nowrap;
        }
        ...
        @media (max-width: 480px) {
            ...
            .table-container {
                max-height: 400px; /* Slightly reduced for mobile */
            }
...
<body>
    <div class="survey-wrapper">
        <div class="survey-header">
            ...
            <p class="header-text">Evaluate the people you interact with. Your feedback shapes insights.</p>
